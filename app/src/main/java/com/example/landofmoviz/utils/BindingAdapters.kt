package com.example.landofmoviz.utils
...
import com.example.landofmoviz.view.activity.movie_detail.MovieDetailsActivity
...
import com.example.landofmoviz.view.activity.tv_detail.TvDetailsActivity
...
fun View.setDetailsIntent(mediaType: MediaType, id: Int, imageUrl: String?, seasonNumber: Int?) {
    ...
    setOnClickListener {
        val intentClass = when (mediaType) {
            ...
            MediaType.TV ->  TvDetailsActivity::class.java // if (seasonNumber == null) TvDetailsActivity::class.java else SeasonDetailsActivity::class.java
