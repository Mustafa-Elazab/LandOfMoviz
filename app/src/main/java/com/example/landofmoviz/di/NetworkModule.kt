...
object NetworkModule {
    ...
    private const val CACHE_SIZE = 1024 * 1024 * 50L // 50 MB
    private const val CACHE_MAX_AGE = 60 * 60 * 24 // 24 hour
    ...
    fun provideRequestInterceptor(): Interceptor = Interceptor { chain ->
        ...
        val url = originalUrl.newBuilder()
            .addQueryParameter("api_key", "0d78a49b1a3056a1df36e1de7787fcda")
